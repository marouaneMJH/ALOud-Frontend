...
<template>
  <CrudLayout page-title="[Item Name] Management">
    <div class="space-y-6">
      ...
      <Modal v-if="showModal" @close="closeModal" :title="editingItem ? 'Edit [Item]' : 'Create [Item]'">
...
- Use `bg-gray-950` for dark backgrounds
- Use `bg-gray-900` for slightly lighter backgrounds
