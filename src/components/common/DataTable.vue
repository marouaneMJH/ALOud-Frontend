<template>
    <div class="space-y-6">
            ...
            <div class="flex-1 flex gap-2">
                <div class="relative flex-1 max-w-md">
                    <input
                        ...
                        type="text"
                        placeholder="Search..."
                        class="w-full px-4 py-2 border border-gold-700 bg-gold-900 text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent placeholder-gray-500"
                    />
                    <div
                        class="absolute inset-0 rounded-lg pointer-events-none shadow-golden-glow opacity-0 focus-within:opacity-100 transition-opacity"
                    />
                </div>
            </div>
            <button
        ...
        <div
            v-else
            class="rounded-lg border border-gold-700 bg-gradient-to-br from-gray-900 via-gray-950 to-gray-900 shadow-lg overflow-hidden"
        >
            <table class="w-full text-sm">
                <thead class="bg-gold-900 border-b border-gold-700">
                    <tr>
                        <th
