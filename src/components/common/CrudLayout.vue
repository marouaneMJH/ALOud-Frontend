  ...
  <div class="flex h-screen bg-gray-900">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <header class="bg-gray-900 border-b border-gold-700 bg-gradient-to-r from-gray-900 via-gray-900 to-gold-950 px-8 py-4 flex justify-between items-center shadow-lg">
        <h2 class="text-2xl font-semibold text-gold-300">{{ pageTitle }}</h2>
        <div class="flex items-center gap-4">
          <button class="text-gold-400 hover:text-gold-200 transition duration-200">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M10.5 1.5H9.5V.5h1v1zm0 17H9.5v-1h1v1zm0-17h1v1h-1v-1zm0 17h1v1h-1v-1zM4.22 4.22L3.51 3.51l.707-.707.707.707zm11.31 11.31l.707.707-.707.707-.707-.707zm0-11.31l.707-.707.707.707-.707.707zm-11.31 11.31l-.707.707-.707-.707.707-.707z"/></svg>
          </button>
          <button class="text-gold-400 hover:text-gold-200 transition duration-200">
